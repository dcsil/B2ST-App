...
# Import the dataset
purchases_dataset = pd.read_csv('datasets/ecommerce-user-events.csv')
...
categorical_features = ['event_type', 'order_id', 'product_id', 'category_code', 'brand', 'price', 'purchases']
le = LabelEncoder()
